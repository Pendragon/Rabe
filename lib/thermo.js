...
var demo = true; 	// If you have no hardware, this prevent error message and return -88.88 degre for all read
 ...
 * @param {object} db, monk database object
 * @param {integer} [optional] interval, millisecond between two hardware read
 */
function Thermo(id, name, db, interval)
{
	this._id = id;
	this._name = name;
	this._db = db;
